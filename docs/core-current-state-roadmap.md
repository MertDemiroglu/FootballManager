...
- Runtime match behavior is unchanged. The next planned implementation phase should stay incremental: `ActionPlan` / `ActionCandidate` / `PlayerIntent` skeleton, not the full simulation engine.
