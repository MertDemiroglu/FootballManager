...
- Match Engine Coordinate Simulation Design documented in `docs/match-engine-design.md`; the bounded coordinate simulator is now the default playable runtime match engine.
